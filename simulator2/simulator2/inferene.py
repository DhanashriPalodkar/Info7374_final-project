...
def blink_detect(log):
    time_frame = 5
    comparision_string = log[-time_frame:]
    for i in range(time_frame):
        pattern = '00000'
        if pattern in comparision_string:
            return True
    return False
...
emotion_model_path = path + '/openCV_helper/' + 'trained_models.16.hdf5'
...
eye_detection_model_path = path + '/openCV_helper/' + 'eye_classifier_17.hdf5'

emotion_labels = {0: "angry", 1: "closed", 2: "disgusted", 3: "fearful", 4: "happy", 5: "neutral", 6: "sad",
                  7: "surprise"}
...
eye_log = defaultdict(str)
eye_conditon = "open"

drosiness_status =  1 #eyes open

f = open("eyestatus.txt","w+")
f.write("Opened file and writing to it")
f.close()
